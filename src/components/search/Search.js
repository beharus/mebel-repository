...
function Search() {
  ...
  return (
    <div className="mx-auto container px-[2%]">
      <div className=" container mx-auto row d-flex align-items-center justify-content-between search my-20">
        ...
        <div className="col-md-3 md:m-auto mt-[30px] col-12 d-flex justify-center md:justify-end">
          <div className="w-9/12 py-[6px] px-3 flex border-[#343434] border">
            <input
              ...
              value={search}
              className=" placeholder-[#D1D1D1] text-[#343434] w-full outline-none border-r-none rounded-none"
